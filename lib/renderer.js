...
(function() {
  ...
  exports.toDOMFragment = function(text, view, filePath, grammar, callback) {
    if (text == null) {
      text = '';
    }
    return render(text, view, filePath, function(error, html) {
  ...
  exports.toHTML = function(text, view, filePath, grammar, callback) {
    if (text == null) {
      text = '';
    }
    return render(text, view, filePath, function(error, html) {
  ...
  render = function(text, view, filePath, callback) {
    var options;
    options = {
      sanitize: false,
    ...
    return jdh(text, view.editorId, function(error, html) {
      if (error != null) {
          return callback(error);
        }
        html = sanitize(html);
